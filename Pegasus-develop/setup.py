...
with open('README.md') as fp:
 ...
 setuptools.setup(
     name='pegasus',
     version='0.0.1',
     description='Pretraining with Extracted Gap for Abstractive Summarization with Sequence-to-sequeunce model'
     long_description=_LONG_DESCRIPTION,
     long_description_content_type='text/markdown',
     author='Google Inc.'
     author_email='no-reply@google.com',
     url='http://github.com/google-reearch/pegasus',
     license='Apache2.0',
